...
#
# SPDX-License-Identifier: (Apache-1.0 OR MIT)
...
class SpackExercise(CMakePackage):
    """Spack code for the Simulation Engineering course."""
    ...
    maintainers("lucia-agullo-marti")
    
    license("MIT", checked_by="lucia-agullo-marti")
    ...
    # Build dependency for all versions
